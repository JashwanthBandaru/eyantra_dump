...
def main():
    ...
    def get_setpoint():
        ...
        if aruco_value_returned !='No_aruco':
            ...
            print("can land")
            #box_x,box_y,box_z = round(position_x2+(position_z2*math.tan(math.radians(40))/200)*(center_x-200),1),round(position_y2-(position_z2*math.tan(math.radians(40))/200)*(center_y-200),1),position_z1
            #box_x1,box_y1,box_z1 = round(position_x2+(position_z2*math.tan(math.radians(40))/200)*(center_x-200)),round(position_y2-(position_z2*math.tan(math.radians(40))/200)*(center_y-200)),position_z
    ...
    while not rospy.is_shutdown():
        ...
        while ([position_x1,position_y1,position_z]!=setpoints[1]):
            ...
            if setpoint_box != None:
                ...
                #while (center_x not in range (197,203) and center_y not in range (197, 203)):
                while (center_x not in range (197,203)):
                    while (True):    
                        setpoint_box =get_setpoint()
                        if setpoint_box != None:
                            break
                ...
                while not ((rospy.get_rostime()-last_request)>rospy.Duration(5)):
                    continue  
