...
# Calling the rosservices
    ...
    def auto_set_mode(self):
        ...
        try:
            armService = rospy.ServiceProxy('mavros/set_mode', mavros_msgs.srv.SetMode)
            armService(custom_mode="AUTO.MISSION")
        except rospy.ServiceException as e:
            print ("Service arming call failed: %s"%e)
    ...
    def wpPush(self,index,wps):
        ...
        try:
            armService = rospy.ServiceProxy('mavros/set_mode', mavros_msgs.srv.WaypointPush,persistent=True)
            armService(start_index = 0,waypoints = wps)
        except rospy.ServiceException as e:
            print ("Service arming call failed: %s"%e)
