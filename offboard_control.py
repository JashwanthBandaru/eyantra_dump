...
class offboard_control:
    ...
    def setparam(self):
        ...
        try:
            ...
            paramService(param_id="COM_RCL_EXCEPT")
            paramService.integer=4
            # paramService.float=4
        except rospy.ServiceException as e:
...
def main():
    ...
    setpoints = [[0,0,10],[10,0,10],[10,10,10],[0,10,10]] #List to setpoints
