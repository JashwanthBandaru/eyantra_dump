...
def drone1():
    ...
    d1_intial=[-1,1]
    setpoints = [[0.0,0.0,3.0],[0.0,16.0,3.0],[25.0,16.0,3.0],[round(13.85-d1_intial[0]),round(-7.4-d1_intial[1]),5.0],[round(13.85-d1_intial[0],1),-7.4-d1_intial[1],1.7]]#List to setpoints
    ...
    def drone_search_box(sp_x,sp_y,sp_z):
        ...
        move_to_setpoint(box_x,box_y,0.0, accuracy=True)
        # print("setpoint: 1m above the box reached")

        # while ([position_x1,position_y1,position_z1]!=[box_x,box_y,-0.2]):
    ...
    while not rospy.is_shutdown():
        ...
        move_to_setpoint(setpoints[3][0],setpoints[3][1],setpoints[3][2])
        print("setpoint 5 reached")

        move_to_setpoint(setpoints[4][0],setpoints[4][1],setpoints[4][2]-2, accuracy=True)
        print("setpoint 6 reached")

        land_drone(pos_z=setpoints[4][2])
        delaying_drone(time=5)
